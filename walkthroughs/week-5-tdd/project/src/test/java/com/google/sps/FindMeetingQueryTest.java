...
public final class FindMeetingQueryTest {
  ...
  public void onlyMandatoryAttendeesAreConsidered() {
    // Have each person have different events. We should see three options because each person has
    // split the restricted times (not counting the optional attendee).
    //
    // Events  :       |--A--|     |--B--|
    //          *|--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void bothMandatoryAndOptionalAttendeesAreConsidered() {
  ...
  public void overlappingEvents() {
    ...
    @Test
  public void multipleOverlappingEvents() {
    // Have an event for each person, but have their events overlap. We should only see one option.
    //
    // Events  :       |--A--|
    //                     |--B--|
    //           |------C------|
  ...
  @Test
  public void nestedAndOverlappingEvents() {
    // Have an event for each person, but have one person's event fully contain another's 
    // event and the other overlap the other two. We should see one option.
    //
    // Events  :       |----A----|
    //                   |--B--|
    //           |--------C--------|
  ...
  public void justEnoughRoom() {
    ...
    @Test
  public void justEnoughRoomWhenIgnoreOptionalAttendee() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting as long as you ignore the optional attendee.
    //
    // Events  : |--A--|     |----A----|
    //         *       |-B-|
    // Day     : |---------------------|
